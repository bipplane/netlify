  ...
  return (
    <section ref={sectionRef} id="about-me" className="py-16 md:py-20 bg-gradient-to-bl from-slate-700 via-slate-800 to-slate-900 text-white p-4 sm:p-8 antialiased flex flex-col items-center w-full overflow-hidden">
      <div className="w-full max-w-3xl px-2 sm:px-0">
        <h2 ref={headingRef} className="text-4xl md:text-5xl font-bold mb-10 text-center opacity-0 text-transparent bg-clip-text bg-gradient-to-r from-cyan-200 via-blue-400 to-indigo-300 brightness-90 select-none">
          About Me
        </h2>
